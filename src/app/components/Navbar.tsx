    ...
    <>
      <header className=' flex flex-col mx-auto justify-between bg-white w-full 2xl:h-[203px]'>
        <div className=' 2xl:h-[45px] md:h-[40px] bg-[#272343] text-white'>
          ...
          <div className='flex md:w-[85%] xl:w-[80%] mx-auto justify-between text-[12px] lg:text-[14px] xl:text-lg text-base pt-2 font-light'>
            <div>Free shipping on all orders over $50</div>
            <ul className='flex h-5 gap-1'>
              <li>Eng</li>
              <li><RiArrowDropDownLine className='text-white xl:text-2xl text-[16px] lg:text-xl mt-1 xl:mt-0 mr-2 p-0' /></li>
              <li>Faqs</li>
              <li><IoAlertCircleOutline className='text-white xl:text-2xl text-[16px]  lg:text-xl  font-semibold xl:mt-0 mt-1 ml-2 p-0' /></li>
              <li>Need Help</li>
            </ul>
          </div>
        </div>
        <div className='xl:h-[84px] md:h-[64px]  pt-4 bg-[#F0F2F3] text-black '>
          <div className='flex md:w-[85%] xl:w-[80%]  mx-auto justify-between'>
            <span >
              ...
              <svg width="30" className='inline-block ' height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <h1 className='inline-block h-8 ml-2 xl:font-semibold text-[20px]  font-medium'>
                Comfortly</h1>
            </span>
